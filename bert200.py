...
@PipelineDecorator.component(return_values=['train_dataset,valid_dataset'], cache=True, task_type=TaskTypes.data_processing, execution_queue="training")
...
def executing_pipeline():
    ...
    train_dataset,valid_dataset=Data_Preprocessing()
